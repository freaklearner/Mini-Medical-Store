...
public class AddItem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Copperplate Gothic Light", 0, 36));
...
ResultSet rs;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            ...
            String query="insert into medicine(name,company,fr,price,sno) values('"+jTextField1.getText()+"','"+jTextField3.getText()+"','"+jTextArea1.getText()+"',"+jTextField4.getText()+",'"+jTextField2.getText()+"');";
